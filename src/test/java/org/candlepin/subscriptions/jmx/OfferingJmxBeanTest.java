...
class OfferingJmxBeanTest {
  ...
  void testSyncOffering() {
    ...
    assertEquals(
        "Offering(sku=MW01485, productName=OpenShift Container Platform, "
            + "productFamily=OpenShift Enterprise, childSkus=[SVCMW01485], "
            + "productIds=[69, 70, 185, 194, 197, 201, 205, 240, 271, 290, 311, 317, 318, "
            + "326, 329, 408, 458, 473, 479, 491, 518, 519, 546, 579, 588, 603, 604, 608, "
            + "610, 645], physicalCores=null, physicalSockets=null, virtualCores=null, "
            + "virtualSockets=null, role=null, serviceLevel=PREMIUM, usage=null)",
        actualMessage);
  }
